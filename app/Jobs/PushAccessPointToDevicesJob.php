...
class PushAccessPointToDevicesJob implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(public readonly AccessPoint $accessPoint) {}

    public function handle(SyncService $syncService): void
    {
        $syncService->pushAccessPointToDevices($this->accessPoint->id);
    }

    /**
     * pushAccessPointToDevices() marks the shared status key as running and only clears it on
