...
class TurnstileCheckPointsTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_matches_rusguard_uuid_regardless_of_case(): void
    {
        ...
        Turnstile::factory()->create(['rusguard_access_point_id' => $uuid, 'name' => 'Point A']);
    ...
    public function test_deactivated_orphaned_turnstile_is_not_reported_as_extra(): void
    {
        Turnstile::factory()->create([
